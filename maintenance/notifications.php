...
if (isset($_GET['read'])) {
    ...
    if ($row && $row['issue_id']) { header("Location: update_issue.php?id={$row['issue_id']}"); } else { header("Location: notifications.php"); }
    exit();
}
...
$u=currentUser(); $pageTitle='Notifications'; $pageSubtitle='Your alerts and assignments';
?>
<!DOCTYPE html>
<html lang="en">
