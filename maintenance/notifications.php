...
if(isset($_GET['read'])){
  ...
  if($row&&$row['issue_id']){header("Location: update_issue.php?id={$row['issue_id']}");}
...
$u=currentUser();$pageTitle='Notifications';$pageSubtitle='Your assignment alerts';
?><!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">
<title>Notifications – Maintenance – FixMyCampus</title>
  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
        <div>
          <div style="font-size:.72rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--burg2);margin-bottom:3px;">Maintenance Inbox</div>
      ...
      <div class="panel-burg" style="border-radius:24px;overflow:hidden;">
        <?php if(empty($allNotifs)):?>
          <div style="text-align:center;padding:56px 20px;">
            ...
            <div style="font-size:.95rem;font-weight:600;color:var(--peach);margin-bottom:6px;">No notifications yet</div>
            <div style="font-size:.8rem;color:var(--peach-dim);">Assignment alerts and status updates will appear here.</div>
          </div>
        <?php else:?>
          <?php
