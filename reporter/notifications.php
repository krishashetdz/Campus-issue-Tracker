  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
        <div>
          <div style="font-size:.72rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--burg2);margin-bottom:3px;">Inbox</div>
      ...
      <div class="panel-burg" style="border-radius:24px;overflow:hidden;">
        <?php if(empty($allNotifs)):?>
          <div style="text-align:center;padding:56px 20px;">
            ...
            <div style="font-size:.95rem;font-weight:600;color:var(--peach);margin-bottom:6px;">You're all caught up!</div>
            <div style="font-size:.8rem;color:var(--peach-dim);">No notifications yet. We'll let you know when something happens.</div>
          </div>
        <?php else:?>
          <?php
