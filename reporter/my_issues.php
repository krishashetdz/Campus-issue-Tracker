  ...
  <div class="main-content">
    ...
    <div class="page-content">
      <form method="GET" class="filter-bar">
        ...
        <input type="text" name="search" placeholder="Search title or location..." value="<?=htmlspecialchars($search)?>" class="bg-[#f8f6f0] border border-[#d4c8b8] text-[#2b0d0d] placeholder-[#8a7575] text-xs rounded-md px-3 py-2 focus:outline-none focus:border-amber-700 focus:ring-1 focus:ring-amber-700" style="flex:1;min-width:150px;">
