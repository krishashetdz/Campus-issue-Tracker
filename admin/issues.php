...
$pageSubtitle = 'Manage and assign campus issues';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <form method="GET" class="filter-bar">
        ...
        <input type="text" name="search" placeholder="Search title, location, reporter..." value="<?= htmlspecialchars($search) ?>" style="flex:1;min-width:180px;">
        <select name="status">
      ...
      <div class="panel">
        <div class="panel-header">
          <span><i class="bi bi-list-ul me-2"></i>Issues <span class="issue-id" style="margin-left:4px;">(<?= count($issues) ?>)</span></span>
        </div>
        <?php if(empty($issues)): ?>
